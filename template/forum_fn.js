	...
	*/
	$container.find('.linklist:not(.navlinks, [data-skip-responsive]), .postbody .post-buttons:not([data-skip-responsive])').each(function() {
		var $this = $(this),
			...
			html = '<li class="responsive-menu hidden"><a href="javascript:void(0);" class="responsive-menu-link"><i class="fa fa-bars"></i></a><div class="dropdown hidden"><ul class="dropdown-contents" /></li>',
	...
	*/
	$container.find('#tabs, #minitabs').not('[data-skip-responsive]').each(function() {
		var $this = $(this),
			...
			$item = $ul.append('<li class="tab responsive-tab" style="display:none;"><a href="javascript:void(0);" class="responsive-tab-link"><i class="fa fa-bars"></i></a><ul class="dropdown tab-dropdown dropdown-contents" style="display: none;">').find('li.responsive-tab'),
